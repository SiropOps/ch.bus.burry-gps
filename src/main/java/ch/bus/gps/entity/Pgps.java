...
public class Pgps implements Serializable {
	...
	public String toString() {
		return "Pgps [id=" + id + ", coordinate=" + coordinate + ", latitudeError=" + latitudeError
				+ ", longitudeError=" + longitudeError + ", altitude=" + altitude + ", altitudeError=" + altitudeError
				+ ", speed=" + speed + ", speedError=" + speedError + ", time=" + time + ", climb=" + climb
				+ ", climbError=" + climbError + ", track=" + track + ", trackError=" + trackError + "]";
	}
