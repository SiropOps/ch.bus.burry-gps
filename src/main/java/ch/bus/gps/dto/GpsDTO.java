...
public class GpsDTO implements Serializable {
	...
	public String toString() {
		return "GpsDTO [latitude=" + latitude + ", epy=" + epy + ", longitude=" + longitude + ", epx=" + epx
				+ ", altitude=" + altitude + ", epv=" + epv + ", speed=" + speed + ", eps=" + eps + ", time=" + time
				+ ", ept=" + ept + ", climb=" + climb + ", epc=" + epc + ", track=" + track + ", epd=" + epd + ", mode="
				+ mode + "]";
	}
